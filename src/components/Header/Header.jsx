        ...
        <div className='flex items-center gap-4 md:gap-10'>
          <div className='text-black dark:text-white'>
            {theme === 'dark' ? (
              ...
              <BsMoon className='cursor-pointer w-5 h-5' onClick={toggleTheme} />
            )}
          </div>
          ...
          >
            <span
              className={`absolute left-0 w-full h-[2px] bg-black dark:bg-white transition-all duration-300 ${
                showMenu ? 'rotate-45 top-[12px] md:top-[14px]' : 'top-1 md:top-2'
              }`}
            ></span>
            <span
              className={`absolute left-0 w-full h-[2px] bg-black dark:bg-white transition-all duration-300 ${
                showMenu ? '-rotate-45 top-[12px] md:top-[14px]' : 'bottom-1 md:bottom-2'
              }`}
            ></span>
          </div>
        </div>
